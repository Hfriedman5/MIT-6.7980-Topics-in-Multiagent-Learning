...
- Label ratings as `Elo` in the FoW interface; use Glicko-1 per-team ratings and the backend API identifier `glicko-1`. Every rated game counts across versions.
