...
- Gate nodes $g_1, ..., g_m$ of six possible types:
  #table(
    ...
    [Assignment], [#image("../figures/ppad/gate_assignment.svg", width: 2.25cm, alt: "Assignment gate.")], [$y = x_1$],
    [Constant], [#image("../figures/ppad/gate_constant.svg", width: 2.25cm, alt: "Constant gate.")], [$y=a$],
    [Addition], [#image("../figures/ppad/gate_addition.svg", width: 2.25cm, alt: "Addition gate.")], [$y=min{1, x_1+x_2}$],
    [Subtraction], [#image("../figures/ppad/gate_subtraction.svg", width: 2.25cm, alt: "Subtraction gate.")], [$y=max{0, x_1-x_2}$],
    [Multiplication], [#image("../figures/ppad/gate_multiplication.svg", width: 2.25cm, alt: "Multiplication gate.")], [$y=max{0,min{1, a dot x_1}}$],
    [Comparison],
    [#image("../figures/ppad/gate_comparison.svg", width: 2.25cm, alt: "Comparison gate.")],
...
#example[
  ...
  #figure[
#image("../figures/ppad/circuit.svg", width: 5cm, alt: "A cyclic arithmetic circuit containing a one-half constant, a comparison gate, and an assignment gate.")]
...
#example[Addition gadget game][
  ...
  #figure(caption: [Addition gadget game. The dashed blue edges denote possible edges in the game, which do not affect the result in @thm-gadget-addition.])[
    #image("../figures/ppad/addition_gadget.svg", width: 4cm, alt: "Addition gadget: input players x and y influence w, and w and the output player z influence each other.")
  ]
