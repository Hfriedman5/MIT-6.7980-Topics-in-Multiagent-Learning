...
#show: gabri_notes.with(
  ...
  title: "Foundations of learning in games",
)
...
#align(center, image("../assets/L04-self_play.svg", width: 90%, alt: "Self-play flow: two regret minimizers exchange strategies and utility feedback."))
