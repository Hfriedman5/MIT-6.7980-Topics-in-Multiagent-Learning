...
#let nashf(
  ...
  for i in range(N) {
    for j in range(N) {
      ...
      line((p - dp / 2, q - dq / 2), (p + dp / 2, q + dq / 2), stroke: .12mm + luma(0%))
    }
  }

  set-style(mark: none)
  for i in range(21) {
    line((i / 20, 0), (i / 20, -.9mm), stroke: .3mm + luma(30%))
    line((0, i / 20), (-.9mm, i / 20), stroke: .3mm + luma(30%))
  }
  content((0, -3mm))[$0$]
  content((-2.5mm, 0))[$0$]
  content((1, -3mm))[$1$]
