...
#let draw-tree(s) = {
  cetz.canvas({
    ...
    info1((0, 0))
    content((.4, 0))[#text(blue, font: "New Computer Modern Sans 08")[A]]
    info1((-1.44, -.96))
    content((-1.44 - .4, -.96))[#text(blue, font: "New Computer Modern Sans 08")[P]]
    info1((1.44, -.96))
    content((1.44 + .4, -.96))[#text(blue, font: "New Computer Modern Sans 08")[Q]]
    info1((-1.44 - .72, -1.92))
    content((-1.44 - .72 - .4, -1.92))[#text(blue, font: "New Computer Modern Sans 08")[B]]
    info1((-1.44 + .72, -1.92))
    content((-1.44 + .72 - .4, -1.92))[#text(blue, font: "New Computer Modern Sans 08")[C]]
    info2((1.44 - .72, -1.92), (1.44 + .72, -1.92))
    content((1.44 + .72 + .4, -1.92))[#text(blue, font: "New Computer Modern Sans 08")[D]]
    ...
    let arr(start, end, lbl: none, hl: false) = {
      ...
      if not hl {
        ...
        mark(ns, ne, symbol: "stealth", fill: black, stroke: .3mm, scale: .7)
      } else {
      ...
      if lbl != none {
        content(mp)[#text(
            ...
            font: "New Computer Modern Sans 08",
            size: 9pt,
            box(fill: luma(94%), inset: (y: .3mm, x: .15mm))[#lbl],
          )]
      }
    }
