...
#let lecture = (lec_num: 1, date: [Tue, Sep 15, 2026], title: "Setting and equilibria: the Nash equilibrium", instructor: [Prof. Constantinos Daskalakis (`costis@mit.edu`)])
...
#math.equation(block: true, numbering: "(1)", $phi_(i \, a_i) (x_1 \, dots.h \, x_n) colon.eq frac(x_(i \, a_i) + [r_(i \, a_i) (x_1 \, dots.h \, x_n)]^(+), 1 + sum_(a'_i in A_i) [r_(i \, a'_i) (x_1 \, dots.h \, x_n)]^(+))$.body) <nif>
