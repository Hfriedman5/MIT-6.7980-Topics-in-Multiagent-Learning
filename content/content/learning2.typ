...
#example[
  ...
  [
    #image("../assets/L06-optimistic.svg", width: 100%, alt: "Comparison of optimistic and non-optimistic MWU and OGD trajectories.")
  ],
...
#example[Poor last-iterate convergence of FTRL, #citep(<Cai2024Jun>)][
  ...
  #align(center, image("../assets/L06-plots.svg", width: 100%, alt: "Entropic, Euclidean and logarithmic optimistic FTRL compared with optimistic gradient ascent near a boundary equilibrium."))
