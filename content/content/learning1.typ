...
[
  #image("../assets/L05-entropy.svg", width: 100%, alt: "Negative entropy on a two-action simplex, minimized at the uniform distribution.")
],
...
#example[
  ...
  [
    #image("../assets/L05-ogd_mwu.svg", width: 100%, alt: "OGD and MWU trajectories in the two-by-two zero-sum game; averages converge to equilibrium.")
  ],
