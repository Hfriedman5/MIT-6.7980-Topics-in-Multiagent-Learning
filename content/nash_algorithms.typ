...
$
  forall med upright("player") med i : med med med & u_i \( a_i \; vx_(- i) \) gt.eq u_i \( a'_i \; vx_(- i) \) \, forall a_i in S_i \, forall a'_i in A_i \;\
...
$
  forall med upright("players") med i \, forall a_i in A_i : med med x_(i \, a_i) > 0 med med arrow.r.double a_i in S_i med med arrow.r.double a_i med upright("is a best response to ") vx_(- i) .
$
